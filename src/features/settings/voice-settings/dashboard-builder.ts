...
export function buildVoiceDashboardEmbed(
  ...
  return new EmbedBuilder()
    ...
    .addFields(
      ...
      {
        name: t(locale, "commands.voice.dashboard.speed"),
        value: `${prefs.tts.speed.toFixed(2)}x`,
        inline: true,
      },
      {
        name: t(locale, "commands.voice.dashboard.pitch"),
        value: prefs.tts.pitch.toFixed(2),
        inline: true,
      },
    );
}

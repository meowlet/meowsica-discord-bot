  ...
  commands: {
    ...
    voice: {
      ...
      dashboard: {
        ...
        providerWavenet: string;
        modelDefault: string;
      };
      buttons: { config: string; reset: string };
      config: {
        title: string;
        subtitle: string;
        ...
        backToTop: string;
        backToTopDesc: string;
        providerPlaceholder: string;
        providerBasicOnly: string;
        providerBasicLabel: string;
        providerBasicDesc: string;
        providerWavenetLabel: string;
        providerWavenetDesc: string;
        providerUpdated: string;
        variantPlaceholder: string;
        variantNotAvailable: string;
        variantNoVoices: string;
        variantUpdated: string;
        noWavenetForLanguage: string;
        speedPlaceholder: string;
        speedUpdated: string;
        speedNormal: string;
        speedNormalDesc: string;
        speedSlow: string;
        ...
        pitchUpdated: string;
        pitchDeep: string;
        pitchDeepDesc: string;
        pitchMediumLow: string;
        pitchMediumLowDesc: string;
        pitchNormal: string;
        pitchNormalDesc: string;
        pitchMediumHigh: string;
        pitchMediumHighDesc: string;
        pitchHigh: string;
        pitchHighDesc: string;
      };
      reset: { success: string; successDesc: string; notOwner: string };
    };
    language: {
      name: string;
      description: string;
      ...
      buttons: { configure: string; close: string; notOwner: string };
      config: {
        title: string;
        subtitle: string;
    ...
    profile: {
      ...
      providerWavenet: string;
      model: { auto: string };
      usage: { notApplicable: string; format: string };
      quotaExceeded: string;
    };
  };
  wavenet: { badge: string; notAvailable: string };
}
